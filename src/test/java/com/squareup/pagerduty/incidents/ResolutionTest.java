...
public final class ResolutionTest {
  ...
  @Test public void resolveDescriptionRequiredIfSpecified() {
    try {
      new Resolution.Builder("Hi").withDescription(null);
      fail();
    } catch (NullPointerException e) {
      assertThat(e).hasMessage("description");
    }
    try {
      new Resolution.Builder("Hi").withDescription("  ");
      fail();
    } catch (IllegalArgumentException e) {
  ...
  @Test public void resolveDetailsNameRequiredIfSpecified() {
    try {
      new Resolution.Builder("Hi").addDetails(null, "Hi");
      fail();
    } catch (NullPointerException e) {
      assertThat(e).hasMessage("name");
    }
    try {
      new Resolution.Builder("Hi").addDetails("  ", "Hi");
      fail();
    } catch (IllegalArgumentException e) {
  ...
  @Test public void resolveDetailsRequiredIfSpecified() {
    try {
      new Resolution.Builder("Hi").addDetails(null);
      fail();
    } catch (NullPointerException e) {
